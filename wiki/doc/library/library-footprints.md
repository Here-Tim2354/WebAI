...
aliases:
  - 前端外部库痕迹
  - Frontend Library Footprints
---

# 前端外部库痕迹索引

这组笔记用于记录“外部库在本项目中实际留下了什么痕迹”，重点不是介绍库本身，而是回答：

- 这个库在项目里落到了哪些文件
- 它具体解决了什么问题
- 它如何影响了当前的代码风格、设计语言或交互实现
...
- [[library/read-excel-file-footprint]]
...
- 想知道“为什么 `.xlsx` 上传后Storage 保存为 `.csv`”，看 [[library/read-excel-file-footprint]]
