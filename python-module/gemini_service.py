...
while True:
    ...
    response=chat.send_message(get_compacted_contents("使用googlesearch和urlcontext阅读该网址，给出基本信息： https://nextjs.org/docs?utm_source=create-next-app&utm_medium=appdir-template-tw&utm_campaign=create-next-app "))
    ...
    print("工具调用的Token："+str(response.usage_metadata.tool_use_prompt_token_count))
